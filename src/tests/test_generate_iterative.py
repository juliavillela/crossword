...
from crosword_generator.generate import IterativeCrosswordGenerator
...
def test_initialization():
    generator = IterativeCrosswordGenerator(["bat","cats"])
...
def test_attempt_build_grid_returns_WordPlacementGrid():
    ...
    generator = IterativeCrosswordGenerator(wordlist)
